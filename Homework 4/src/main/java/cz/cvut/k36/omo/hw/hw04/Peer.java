...
public class Peer implements PeerInterface {
    ...
    /**
     * Mapovani z uzlu na bitovou mapu urcujici ktere bloky ma dany uzel k dispozici.
     */
    ...
    /**
     * Vyzvedne nejstarsi zpravu z fronty zprav a zpracuje ji pomoci zadaneho navstevnika. Pokud ve
     * fronte zadna zprava neni, zasle sam sobe a zpracuje zpravu "idle". Vrati true v pripade, ze
     * tento uzel stahnul vsechny bloky, false jinak.
     */
    public boolean processMessage(MessageVisitor visitor) {
        return (messageQueue.isEmpty() ? new IdleMessage(this) : messageQueue.poll()).accept(
            visitor);
    }
}
