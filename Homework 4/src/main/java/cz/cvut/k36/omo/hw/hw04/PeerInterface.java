...
/**
 * Instance implementujici PeerInterface reprezentuje lokalni uzel nebo uzel pripojeny pres sit.
 */
public interface PeerInterface {

    /**
     * Sdeli vzdalenemu uzlu, ze uzel sender prave obdrzel blok s indexem blockIndex.
     */
